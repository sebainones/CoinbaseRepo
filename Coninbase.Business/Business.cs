...
namespace CoinBase.Business
{
    public class Business : IBusiness
    {
        ...
        public async Task<BuyPrice> GetBuyPriceAsync(string currenciesPair)
        {
            ...
            var result = await coinBaseClient.MakeAuthorizedRequestCall<BuyPriceResponse>(@$"/v2/prices/{currenciesPair}/buy", string.Empty);
            return result.Data;
        }
        ...
        public async Task<ExchangeRateData> GetExchangeRatesAsync(string currency)
        {
